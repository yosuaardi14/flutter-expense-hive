...
class ExpenseListView extends StatelessWidget {
  ...
  const ExpenseListView(this.state, {super.key});
  ...
  void addExpense() {
    Get.put(ExpenseAddController()).resetForm(state.isExpense.value);
    ...
    return Card(
      ...
      child: ExpansionTile(
        title: Row(
          ...
          children: [
            Text(date),
            Text(rupiahFormat(state.totalSpend(data))),
          ...
          children: [
            Expanded(
              child: DropdownButtonFormField<String>(
                value: state.filterValue.value["type"],
                items: [
                ...
                onChanged: (val) {
                  state.filterValue.value["type"] = val!;
                },
              ),
            ),
            ...
            Expanded(
              child: DropdownButtonFormField<String>(
                value: state.filterValue.value["payment"],
                items: [
                ...
                onChanged: (val) {
                  state.filterValue.value["payment"] = val!;
                },
              ),
            ),
          ],
      ...
      Padding(
        ...
        child: Row(
          children: [
            Expanded(
              child: DropdownButtonFormField<String>(
                value: state.filterValue.value["month"],
                items: [
                ...
                onChanged: (val) {
                  state.filterValue.value["month"] = val!;
                },
              ),
            ),
            const SizedBox(width: 10),
            Expanded(
              child: DropdownButtonFormField<String>(
                value: state.filterValue.value["year"],
                items: [
                  ...state.listYear.value.map(
                    (e) => DropdownMenuItem<String>(
                      value: e,
                      child: Text(e),
                    ),
                ...
                onChanged: (val) {
                  state.filterValue.value["year"] = val!;
                },
              ),
            ),
          ],
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: ElevatedButton(
                onPressed: () {
                  state.filterData(state.filterValue.value);
                },
    ...
    return Scaffold(
      appBar: AppBar(
        title: ValueListenableBuilder(
          valueListenable: state.isExpense,
          builder: (context, val, child) => Text(
            'Expense App - ${val ? "Outcome" : "Income"}',
          ),
        ),
        centerTitle: false,
        actions: [
          IconButton(
            onPressed: state.switchList,
        ...
        child: Column(
          children: [
            ...
            ValueListenableBuilder(
              valueListenable: state.showChart,
            ...
            ValueListenableBuilder(
              valueListenable: state.showList,
              builder: (context, val, child) {
                if (val) {
                  return Expanded(
                    child: ValueListenableBuilder(
                      ...
                      builder: (context, val, child) {
                        ...
                        return ValueListenableBuilder(
                          valueListenable: state.expenseData,
                          builder: (context, val, child) {
                            return ListView(
                              children: val.entries.isEmpty
                                  ? const [
                                      SizedBox(height: 10),
                                      Center(
